...
def load_data_cell_line(tissue_map, drug, tissue_arg, K, path='/home-nfs/wangsheng/GDSC_PDX_WP_feature/'):
	...
	for ind, (temp_tissue, temp_cell_line_list) in enumerate(tissue_map.items()):
		tissue_index_map[temp_tissue] = ind
		...
		tissue_order.append(temp_tissue)
	...
	return cv_feature_list[i], cv_label_list[i], cv_tissue_index_list[i], vali_feature_list[i], vali_label_list[i], vali_tissue_list[i]
